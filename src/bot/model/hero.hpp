...
public:
	Hero( int level, int high_tier_army_num, int mid_tier_army_num, int low_tier_army_num, int x, int y ) : GameObject(x, y),
		level_( level ), army_( high_tier_army_num, mid_tier_army_num, low_tier_army_num, x, y ){}
